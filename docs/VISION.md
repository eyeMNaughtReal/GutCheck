...
- **Name:** Mark Conley
- **Expertise:** Quality Assurance for FDOT (Florida Department of Transportation) projects
- **Background:** In 2010, Mark started having issues digesting mammalian products — beginning with red meat and progressing over time to ice cream and dairy. He was tested for Alpha-gal Syndrome, which came back negative, and has seen a gastroenterologist three times without a diagnosis. GutCheck was inspired by his own digestive issues — an effort to track exactly what triggers his symptoms and how long it takes from consumption to reaction, in order to identify what's going on and find alternatives that let him enjoy eating again. He knows he isn't the only one dealing with this, so he built it to help anyone keep a food journal they can bring to their doctor.

## Purpose

- **Who you help:** Anyone with chronic, hard-to-pin-down GI symptoms who needs a food/symptom journal to bring to their doctor.
- **Problem you solve:** Food becomes the enemy — people avoid entire food categories out of fear and uncertainty. At the same time, doctors can't diagnose what patients can't document: standard panels (like Mark's Alpha-gal test) come back negative, and there's no next step because the patient's only evidence is a vague memory, not structured, dated data.
...
- **Why you:** Lived it, not imagined it. 15 years of personally experiencing this exact problem — negative Alpha-gal test, three unproductive GI specialist visits, no diagnosis — means Mark is building the tool he's been missing the whole time, not guessing at what a user needs.
...
- **Go-to-market:** Community-first — engage directly in existing patient communities (Reddit's r/ibs and r/AlphaGalSyndrome, Alpha-gal Facebook groups, food-intolerance forums), sharing Mark's own story and offering TestFlight access.
